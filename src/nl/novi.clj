(ns nl.novi
  (:require [com.biffweb :as biff]
            [nl.novi.email :as email]
            [nl.novi.app :as app]
            [nl.novi.home :as home]
            [nl.novi.middleware :as mid]
            [nl.novi.ui :as ui]
            [nl.novi.worker :as worker]
            [nl.novi.schema :as schema]
...
(defn on-save [ctx]
  ...
  (biff/eval-files! ctx)
  (generate-assets! ctx)
  (test/run-all-tests #"nl.novi.*-test"))
